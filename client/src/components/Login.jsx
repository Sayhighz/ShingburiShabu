            ...
            <div className='card-body items-left text-left shadow-xl'>
                <form action="" onSubmit={handleSubmit}>
                    ...
                    <div className='input-field m-5'>
                        ...
                        onChange={(e) => setValues({...values, email : e.target.value})} autoComplete='off' placeholder='Enter Email'/>
                    </div>
                    <div className='input-field m-5'>
                        <label htmlFor="password">Password: </label>
                        <input className="input input-bordered w-full max-w-xs" type="password" name='password' autoComplete='off' 
                        onChange={(e) => setValues({...values, password : e.target.value})} placeholder='Enter Password'/>
                    </div>
